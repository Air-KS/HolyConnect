...
function ApLocation({ navigation }) {
      ...
      <View style={locationStyle.addressContainer}>
        <ScrollView>
          <Text style={locationStyle.adressText}>
            Ici sera l'adresse complète du logement à louer.
            L'adresse s'affiche dans un petit menu déroulant qui permet donc
            de ne pas être limité quant au nombre de caractères maximum !
          </Text>
        </ScrollView>
      </View>
